...
(function(I, R, v) {
    let K;
    (K = v.define) && K.amd ? K([], function() { return R }) : (K = v.modules) ? K[I.toLowerCase()] = R : "object" === typeof exports ? module.exports = R : v[I] = R
})("FlexSearch", function ma(I) {
    function v(a, b) {
        const c = b ? b.id : a && a.id;
        this.id = c || 0 === c ? c : na++;
        this.init(a, b);
        fa(this, "index", function() { return this.a ? Object.keys(this.a.index[this.a.keys[0]].c) : Object.keys(this.c) });
        fa(this, "length", function() { return this.index.length })
    }
    ...
    function W(a, b) {
        const c = a.length,
            d = O(b),
            e = [];
        for (let f = 0, g = 0; f < c; f++) { const h = a[f]; if (d && b(h) || !d && !b[h]) e[g++] = h }
        return e
    }
    ...
    function fa(a, b, c) { Object.defineProperty(a, b, { get: c }) }

    function q(a) { return new RegExp(a, "g") }

    function Q(a, b) { for (let c = 0; c < b.length; c += 2) a = a.replace(b[c], b[c + 1]); return a }
            ...
            for (let d = 0, e = c.length; d < e; d++) {
                ...
                if (g)
                    for (let h = 0, l = g.length; h < l; h++)
                        if (g[h] === b) { 1 === l ? delete a[f] : g.splice(h, 1); break } else J(g[h]) && ba(g[h], b)
            }
        }
    }
    ...
    function ca(a) {
        ...
        for (let e = 0; e < a.length; e++) {
            const f = a[e];
            if (f !== c)
                if (e && "h" === f) { if (d = "a" === d || "e" === d || "i" === d || "o" === d || "u" === d || "y" === d, ("a" === c || "e" === c || "i" === c || "o" === c || "u" === c || "y" === c) && d || " " === c) b += f } else b += f;
    ...
    function qa(a, b) { a = a.length - b.length; return 0 > a ? 1 : a ? -1 : 0 }
    ...
    function oa(a, b) { const c = L.length; for (let d = 0; d < c; d++) a = a[L[d]], b = b[L[d]]; return a < b ? -1 : a > b ? 1 : 0 }

    function T(a, b, c) { return a ? { page: a, next: b ? "" + b : null, result: c } : c }

    function ha(a, b, c, d, e, f, g) {
        let h, l = [];
        if (!0 === c) { c = "0"; var m = "" } else m = c && c.split(":");
        const n = a.length;
        if (1 < n) {
            const y = B(),
                r = [];
    ...
    function E(a) { return a.constructor === Array }

    function O(a) { return "function" === typeof a }

    function J(a) { return "object" === typeof a }

    function H(a) { return "undefined" === typeof a }

    function ia(a) { const b = Array(a); for (let c = 0; c < a; c++) b[c] = B(); return b }

    function B() { return Object.create(null) }
    ...
    function sa() {
        ...
        self.onmessage = function(c) {
            if (c =
                c.data)
                if (c.search) {
                    const d = b.search(c.content, c.threshold ? { limit: c.limit, threshold: c.threshold, where: c.where } : c.limit);
                    self.postMessage({ id: a, content: c.content, limit: c.limit, result: d })
    ...
    function ta(a, b, c, d) {
        ...
        const e = ma.toString();
        c.id = b;
        a.postMessage({ register: e, options: c, id: b });
        return a
    }
    const F = { encode: "icase", f: "forward", split: /\W+/, cache: !1, async: !1, g: !1, D: !1, a: !1, b: 9, threshold: 0, depth: 0 },
        ja = {
    ...
    const ka = {},
        la = {};
    v.create = function(a, b) { return new v(a, b) };
    v.registerMatcher = function(a) { for (const b in a) a.hasOwnProperty(b) && aa.push(q(b), a[b]); return this };
    v.registerEncoder = function(a, b) { U[a] = b.bind(U); return this };
    ...
    v.prototype.addMatcher = function(a) { const b = this.v; for (const c in a) a.hasOwnProperty(c) && b.push(q(c), a[c]); return this };
    v.prototype.add = function(a, b, c, d, e) {
        if (this.a && J(a)) return this.A("add", a, b);
        if (b && M(b) && (a || 0 === a)) {
            var f = "@" + a;
            if (this.c[f] && !d) return this.update(a, b);
            if (this.g) return ++this.C >= this.m.length && (this.C = 0), this.m[this.C].postMessage({ add: !0, id: a, content: b }), this.c[f] = "" + this.C, c && c(), this;
            if (!e) {
                ...
                if (g) {
                    ...
                    switch (c) {
                        ...
                        case "forward":
                            ...
                            break;
                        case "full":
                            for (n = 0; n < h; n++) { const w = (y ? n + 1 : h - n) / h; for (let x = h; x > n; x--) m = g.substring(n, x), V(z, p, m, a, w, l, u, A - 1) }
                            break;
                        default:
    ...
    v.prototype.remove = function(a, b, c) {
        ...
        var d = "@" + a;
        if (this.c[d]) {
            if (this.g) return this.m[this.c[d]].postMessage({ remove: !0, id: a }), delete this.c[d], b && b(), this;
            if (!c) {
                if (this.async &&
    ...
    v.prototype.search = function(a, b, c, d) {
        ...
        if (this.a) {
            ...
            if (this.g) {
                ...
                this.u = 0;
                this.o = [];
                for (n = 0; n < this.g; n++) this.m[n].postMessage({ search: !0, limit: b, content: g });
                return
            }
            if (c) return c(P.call(this, a, r, f, l, b, m, y, h, x, w));
            if (this.async) { const G = this; return new Promise(function(C) { Promise.all(f).then(function(D) { C(P.call(G, a, r, D, l, b, m, y, h, x, w)) }) }) }
        ...
        g = a;
        if (this.cache)
            if (this.B) { if (c = this.l.get(a)) return c } else this.l.clear(), this.B = !0;
        g = this.encode(g);
    ...
    v.prototype.find = function(a, b) { return this.where(a, b, 1)[0] || null };
    ...
    v.prototype.info = function() {
        if (this.g)
            for (let a = 0; a < this.g; a++) this.m[a].postMessage({ info: !0, id: this.id });
        else return {
            id: this.id,
            items: this.length,
    ...
    v.prototype.clear = function() { return this.destroy().init() };
    ...
    const U = {
            ...
            simple: function() {
                ...
                return function(b) { b = Q(b.toLowerCase(), a); return " " === b ? "" : b }
            }(),
            advanced: function() {
